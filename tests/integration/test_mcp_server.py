"""MCP server boundary: the 35 registered tool names are a STABLE contract.
...
# Golden contract — the exact 35 registered tool names (see docs/mcp/tools.md).
...
EXPECTED_ALL = sorted(EXPECTED_MARKET_DATA_TOOLS + EXPECTED_OPTIONS_TOOLS)
